...
#define AUTHORS \
  proper_name_utf8 ("Torbjorn Granlund", "Torbj\303\266rn Granlund(coreutils)"), \
  proper_name ("David MacKenzie(coreutils)"), \
  proper_name ("Jim Meyering(coreutils)"), \
  proper_name ("Hans IJntema(checksum)")
